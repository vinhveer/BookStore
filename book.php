...
<body>
    ...
    <div class="container mt-3 text-center">
        <div class="row align-items-center">
            <div class="col">
                <div class="card">
                    <img src="assets\images\cover_book\image.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6 class="card-title">Onyx Storm (Deluxe Limited Edition) (The Empyrean, 3) Hardcover – January
                            21, 2025</h6>
                    </div>
