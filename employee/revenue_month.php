                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if (!$conn) {
                                ...
                                $sql = "SELECT 
                                            CONCAT(MONTH(Ngay), '/', YEAR(Ngay)) AS Month,
                                        ...
                                        FROM (
                                            ...
                                            FROM 
                                                orders_offline
                                            GROUP BY 
                                                MONTH(order_date_off), YEAR(order_date_off), order_date_off
                                            ...
                                            GROUP BY 
                                                MONTH(order_date_on), YEAR(order_date_on), order_date_on
                                        ) AS T
                                        GROUP BY 
                                            CONCAT(MONTH(Ngay), '/', YEAR(Ngay))";
