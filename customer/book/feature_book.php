<?php
if ($_SERVER['SCRIPT_NAME'] !== "/customer/book/see_more.php") {
...
<div class="container mt-4">
    <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-3 text-end">
            <?php if ($_SERVER['SCRIPT_NAME'] !== "/customer/book/see_more.php"): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column" style="height: 40%">
                                <a href="book_details.php?book_id=<?php echo $row_book['product_id'] ?>">
                                    <h5 class="card-title">
                                        <?php
